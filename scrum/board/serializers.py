...
class TaskSerializer(serializers.ModelSerializer):
    ...
    status_displays = serializers.SerializerMethodField('get_status_display')
    link = serializers.SerializerMethodField('get_links')

    class Meta:
        model = Task
        fields = ('id', 'name', 'description', 'sprint',
            'status', 'status_displays', 'order',
            'assigned', 'started', 'due', 'completed', 'link',)
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('id', User.USERNAME_FIELD, 'full_name', 'is_active', 'link')
